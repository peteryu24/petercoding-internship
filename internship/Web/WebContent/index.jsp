...
<body>
    <div class="container">
        ...
        <p>
        	...
        	<br>
        	데이터 통신의 다양한 경험을 위해 xhr를 사용하려고 했으나,
        	<br>
        ...
        <h5>전체 구조</h5>
        <p>
        	DBCP Connection Pool을 이용한 효율성
        	<br><br>
        	아이디와 게시물 첨부파일 댓글은 모두 왜래키로 연관성을 가짐
        	<br>
        	...
        	모든 페이지에 세션 개념 탑재
        	<br>
        	<span style="color: red;">url링크만으로 접속 불가</span>
        	<br><br>
        	파일 다운로드시 이상한 xml문서의 압축 파일로 다운(검토 필요)
        </p>
